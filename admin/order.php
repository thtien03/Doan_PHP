<?php require_once("../entities/orders.class.php");
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php echo number_format($item["total"], 0, '', ',').' VNĐ'; ?></td>
                                            <td class="text-center">
                                                <?php if($item["order_code"] != 0) echo $item["order_code"]; else echo "Chưa có" ?>
                                            </td>
                                            <td class="text-center">
                                                <?php if($item["status"] == 3) echo 'Đã thanh toán';?>
