...
if (isset($_POST["btnsubmit"])) {
    $product_id = null; // Let the class handle ID generation
    ...
    if (!$result) {
        ...
        // Redirect to add storehouse details
        header("Location: add-storehouse.php?product_id=" . $newProduct->product_id);
    }
}
?>
<!-- Header -->
