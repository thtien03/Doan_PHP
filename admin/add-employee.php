<?php require_once("../entities/role.class.php"); 
?>
<?php 
$role = Role::list_role();
?>
<?php require_once("../entities/employee.class.php"); 
...
if (isset($_POST["btnsubmit"])) {
    ...
    $newEmployee = new Employee($employee_id,$name, $phone, $birthday, $gender, $email, $role_id,$hashed_str,$status,$created_at);
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="card-body">
                                        ...
                                        <fieldset class="form-group">
                                            <input type="tel" class="form-control" name="txtphone" required pattern="[0-9]{10}"
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="card-body">
                                        ...
                                        <fieldset class="form-group">
                                            <input type="password" class="form-control" id="basicInput" name="txtpassword" required
