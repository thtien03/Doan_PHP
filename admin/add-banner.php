                            ...
                            <div class="card-block">
                                <div class="card-body">
                                    ...
                                    <fieldset class="form-group">
                                        <input type="text" class="form-control" id="basicInput" name="txtcaption" value="<?php echo isset($_POST["txtcaption"]) ? $_POST["txtcaption"] : ""; ?>">
                                    </fieldset>
                                    <h5 class="mt-2">Nội dung</h5>
                                    <fieldset class="form-group">
                                        <textarea class="form-control" id="basicTextarea" rows="3" name="txtcontent" value="<?php echo isset($_POST["txtcontent"]) ? $_POST["txtcontent"] : ""; ?>"></textarea>
                                    </fieldset>
