...
$order_history = Orders::getCustomerOrderHistory($customer_id);
            ...
            <div class="container size-210 mx-auto p-lr-20 p-t-55 p-b-70 p-lr-15-lg w-full-md">
              <div class="container">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <?php 
                    if(isset($order_history) && count($order_history) > 0) {
                      foreach($order_history as $order) { 
                        $item_count = Orderdetail::getOrderItemCount($order["orders_id"]);
                    ?>
                    <tr>
                      ...
                      <td><?php echo Orders::getOrderStatusText($order["status"]); ?></td>
                    </tr>
                    <?php 
                      }
                    } else { 
