  ...
  function showCart(){
    if(isset($_SESSION['cart'])&&(is_array($_SESSION['cart'])))
    {
            ...
            <tr class="table_head">
                                ...
                                <th class="column-6"  style="width: 200px;">'.number_format($total_bill, 0, '', ',').' VNĐ'.'</th>
                            </tr>
            ';             
    }
    else{
...
if (isset($_POST['btnCheckout'])) {
        ...
        if(!$result){
            ...
            {
                for ($i=0; $i < sizeof($_SESSION['cart']) ; $i++) {
                    $product_id = (string) trim($_SESSION['cart'][$i][0]);
                    $orders_id = (string) trim($orders_id);
                    $color_id = (string) trim($_SESSION['cart'][$i][4]);
                    ...
                    if($total_orderdetail != null  && $total_quantity_in_orderdetail != null){
            ...
            <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                <div class="m-l-25 m-r--38 m-lr-0-xl">
                    ...
                    <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                        ...
                        <a href="shopping-cart.php?delcart=1"><input type="button"
                ...
                <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                    ...
                    <div class="flex-w flex-t bor12 p-b-13">
                        ...
                        <div class="size-209">
                            <div class="bor8 bg0 m-b-12">
                                <input readonly class="stext-111 cl8 plh3 size-111 p-lr-15" type="text"
                                    name="customer_name"
                                    value="<?php if (isset( $_SESSION["user_login"])) echo $_SESSION["user_login"]["name"];?>">
                            </div>
                        </div>
                    ...
                    <div class="flex-w flex-t bor12 p-t-15 p-b-13">
                        ...
                        <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                            <div class="bor8 bg0 m-b-12">
                                <input readonly class="stext-111 cl8 plh3 size-111 p-lr-15" type="number" name="phone"
                                    value="<?php if (isset( $_SESSION["user_login"])) echo $_SESSION["user_login"]["phone"];?>">
                            </div>
                        </div>
                    </div>
                    <div class="flex-w flex-t bor12 p-t-15 p-b-13">
                        ...
                        <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                            <div class="bor8 bg0 m-b-12">
                                <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="address"
                                    value="<?php if (isset( $_SESSION["user_login"])) echo $_SESSION["user_login"]["address"];?>"
                                    required>
                            </div>
                        </div>
                    </div>
                    ...
                    <input class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer"
                        type="submit" value="Đặt hàng" name="btnCheckout" id="accept">
                    <?php 
