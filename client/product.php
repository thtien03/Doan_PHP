...
if(isset($_POST["btn-search-product"])){
    $query =$_POST["search-product"];
    $products = Product::list_product_search($query);
}
        ...
        <div class="flex-w flex-sb-m p-b-52">
            <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                ...
                <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
                    data-filter=".<?php echo $item["category_id"]; ?>">
                    <?php echo $item["name"]; ?>
                </button>
                <?php endforeach; ?>
            </div>
            ...
            <div class="dis-none panel-search w-full p-t-10 p-b-15">
                <form class="bor8 dis-flex p-l-15" method="POST">
                    <button type="submit" class="size-113 flex-c-m fs-16 cl2 hov-cl1 trans-04"
                        name="btn-search-product">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $item["category_id"]; ?>">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        ...
                        <a href="product-detail.php?product_id=<?php echo $item["product_id"]; ?>"
                            class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1 test-detail">
                            Chi tiết
                        </a>
                    </div>
